  ...
  return (
    <div style={{ padding: "40px", maxWidth: "1100px", margin: "0 auto" }}>
      ...
      <p style={{ color: "#555", fontSize: "15px", marginBottom: "32px" }}>
        Search by name, artist, or filter by vibe.
      </p>
      ...
      <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", marginBottom: "32px" }}>
        <span style={{ fontSize: "12px", color: "#333", alignSelf: "center", marginRight: "4px" }}>
          QUICK FILTERS
        </span>
        {PRESETS.map(p => (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
            {results.map((track) => (
              <div key={track.id} className="card" style={{
                ...
                <button
                  onClick={() => play(track.id, track.name, track.artist)}
                  style={{
                ...
                <div style={{ display: "flex", gap: "8px", flexShrink: 0 }}>
                  {track.tempo && (
                    <span style={{
                      ...
                      background: "#151515", padding: "3px 8px", borderRadius: "4px"
                    }}>
                  ...
                  {track.valence && (
                    <span style={{
                      ...
                      borderRadius: "4px", background: "#151515",
                      color: moodColor(track.valence)
                    }}>
                      {track.valence < 0.3 ? "dark" : track.valence < 0.6 ? "neutral" : "happy"}
                    </span>
                  )}
                  <span style={{ fontSize: "11px", color: "#2a2a2a", padding: "3px 8px" }}>
                    {track.saved_at}
                  </span>
                </div>
              </div>
